  ...
  return <div className="w-full h-full flex flex-row items-center justify-center">
      ...
      <div className = " flex justify-center items-center w-screen h-screen relative overflow-hidden">
        ...
        <div className = "justify-center items-center flex-col flex w-[580px] abssolute">
          ...
          <div className = "flex w-[360px] h-[120px] border-2 border-white bg-black bg-opacity-70 rounded-lg rounded-tl-none p-6 text-[20px] absolute right-64 top-80">
            <p>미스터리 해결의 여정을<br/> 시작하시겠습니까?</p>
          </div>
          <button onClick={()=>navigate('/game')}className = "flex justify-center items-center absolute bottom-14 text-white font-custom text-[96px]  border-4 border-b-white-500 border-t-white-400 border-l-0 border-r-0 pb-2">start</button>
        </div>
